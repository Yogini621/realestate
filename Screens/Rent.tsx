...
const Rent: React.FC<Props> = ({navigation}) => {
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <Text style={styles.stCrystalText}>St.Crystal</Text>
        <Text style={styles.addressText}>210 US Highway,Highland Lake,FL</Text>
        <View style={styles.buttonView}>
          ...
          <TouchableOpacity style={styles.shareButton}>
            <MaterialIcons name="favorite-border" size={22} color="#073762" />
