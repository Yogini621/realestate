...
import {addPrivacyPolicy, addTermsDraft} from '../redux/actions/actionTypes';
...
const PrivacyPolicyAdmin: React.FC<Props> = ({navigation}) => {
  ...
  const handleAddPolicy = () => {
    if (title === '') {
      ...
      dispatch(addPrivacyPolicy({id: Date.now(), title, description}));
    }
  };
      ...
      <ScrollView>
        ...
        <View style={styles.draftButtonView}>
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('PolicyDraft')}>
